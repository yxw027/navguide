...
void FindMatches(SiftImage im1, Keypoint keys1, SiftImage im2, Keypoint keys2);
Keypoint CheckForMatch(Keypoint key, Keypoint klist);
SiftImage CombineImagesVertically(SiftImage im1, SiftImage im2);
