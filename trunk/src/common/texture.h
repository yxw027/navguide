...
void 
glutil_texture_draw_3d_pt (GLUtilTexture * t, double *p);

void
glutil_texture_draw_pt (GLUtilTexture * t, double x0, double y0, double x1, double y1, 
                        double x2, double y2, double x3, double y3);

/**
 * glutil_texture_draw_color4f:
 *
 * renders the texture similar to glutil_texture_draw, but calls
 * glColor4f with the specified colors instead of 1, 1, 1
 */
void glutil_texture_draw_color4f (GLUtilTexture * t, double r, double g, 
        double b, double a);
...
int glutil_texture_get_max_data_size (GLUtilTexture *t);
