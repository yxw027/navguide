...
int nmea_subscribe (gps_nmea_t * gn, lc_t * lc, const char * channel,
        gps_state_handler_t handler, void * userdata);
int nmea_unsubscribe (gps_nmea_t * gn, lc_t * lc, const char * channel,
        gps_state_handler_t handler, void * userdata);
void nmea_free (gps_nmea_t * gn);
void nmea_state_clear (gps_state_t * gd);
void nmea_parse (gps_state_t * gd, const nmea_t *_nmea);
