...
gtku_param_widget_init (GtkuParamWidget *pw)
{
    ...
    pw->widgets = NULL;
    pw->params = g_hash_table_new_full (g_str_hash, g_str_equal, free, 
            NULL);
        ...
        GtkWidget *w, const char *signal_name)
{
    ...
    g_hash_table_insert (pw->params, strdup (name), w);
        ...
        int min, int max, int increment, int initial_value)
{
    ...
    g_object_set_data (G_OBJECT(w), "data-type", (void*)"int");
        ...
        double min, double max, double increment, double initial_value)
{
    ...
    add_row (pw, name, w, "value-changed");
    g_object_set_data (G_OBJECT(w), "data-type", (void*)"double");
    return 0;
}
        ...
        int checked)
{
    ...
    g_hash_table_insert (pw->params, strdup (name), cb);
    g_object_set_data (G_OBJECT(cb), "data-type", (void*)"boolean");
        ...
        int checked)
{
    ...
    g_hash_table_insert (pw->params, strdup (name), tb);
    g_object_set_data (G_OBJECT(tb), "data-type", (void*)"boolean");
        ...
        int noptions, const char **names, const int *values)
{
    ...
    g_object_set_data (G_OBJECT(mb), "data-type", (void*)"enum");
    return 0;
}
        ...
        const char *string1, int value1, ...)
{
    ...
    int status = gtku_param_widget_add_enumv (pw, name, ui_hints, 
            ...
            (int*) values->data);
    for (int i=0; i<(int)values->len; i++) free (g_ptr_array_index (names, i));
...
int gtku_param_widget_get_int (GtkuParamWidget *pw, const char *name)
{
    ...
    GtkWidget *w = (GtkWidget*)g_hash_table_lookup (pw->params, name);
...
_param_load_from_keyfile (void *key, void *value, void *user_data)
{
    ...
    _keyfile_data_t *data = (_keyfile_data_t *)user_data;
    const char *param_name = (const char *)key;
    const char *type = (const char*)g_object_get_data (G_OBJECT(w), "data-type");
    GError *gerr = NULL;
